...
| AI fitness domain               | absent   | Требуется для первого пилота. Backend хранит подтверждённые цели и ограниченный plan envelope, но evidence-approved содержание питания и тренировок, дневники, прогресс и mobile UX ещё не реализованы.                                                                                                                                                                                                                  |
...
| Persistent user memory          | absent   | Обязательна в первом пилоте. Backend сохраняет подтверждённый профиль, цели, замеры, safety, версии планов и provenance, поддерживает исправления/удаление и bounded context. Питание, тренировки, полный профильный UX и AI coach ещё отсутствуют; наличие backend foundation не активирует capability.                                                                                                                     |
| Today dashboard                 | absent   | Мобильный каркас реализует утверждённые пять вкладок, честное пустое состояние «Сегодня», верхнюю информационную плашку и переход из неё в энергетический календарь «Прогресса». Реальные дневные данные, план, быстрое добавление и контекстные обращения ещё отсутствуют, поэтому пользовательский capability пока не активирован.                                                                                                                                                        |
