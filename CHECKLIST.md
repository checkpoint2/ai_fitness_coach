...
| Hybrid onboarding               | absent   | Обязателен в первом пилоте. Ручной authenticated backend flow, contracts, state rules и PostgreSQL persistence существуют; mobile UX, AI-извлечение и голос ещё отсутствуют, поэтому пользовательский capability не активирован.                                                                                                                                                                                         |
