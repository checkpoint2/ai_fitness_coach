...
| `D-0011` | ACTIVE | 2026-08-29 | Onboarding privacy | After structured confirmation, the source narrative is deleted by default and is retained as a coach note only after a separate explicit choice with a full-text preview; source audio is never stored. | [Onboarding: Свободный рассказ и его хранение](ONBOARDING.md#3-свободный-рассказ-и-его-хранение) | Explicit owner change to draft retention or applicable privacy requirements |
| `D-0012` | ACTIVE | 2026-08-29 | Onboarding data | A user may continue without birth year or a male/female calculation-sex selection; the product makes no inference, suppresses false precision, and explains the limitation. | [Onboarding: Основные данные](ONBOARDING.md#51-основные-данные) | Evidence-reviewed calculation requirements or explicit owner change |
| `D-0013` | ACTIVE | 2026-08-29 | Onboarding safety | Unresolved pain, injury, clinician restriction, or applicability doubt permits profile save but blocks the affected automatic plan; the product neither diagnoses nor determines safe load from free text. | [Onboarding: Короткий safety-checkpoint](ONBOARDING.md#7-короткий-safety-checkpoint) | Reviewed safety process, clinical/legal review, or explicit owner change |
