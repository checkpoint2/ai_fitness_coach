...
const innerLayerAllowedPackages = ['@ai-fitness-coach/contracts', 'zod']
...
function resolveRepositoryImport(importer, specifier) {
  ...
  const workspaceAlias = specifier.match(/^@(ai-fitness-coach)\/(backend|contracts|webapp|website|mobile)(?:\/(.*))?$/)
  if (workspaceAlias) {
