...
const testIds = {
  ...
  ONBOARDING_ADULT_ID: 'onboarding.adult-confirmed-button',
  ONBOARDING_ALLERGIES_NONE_ID: 'onboarding.allergies-none-button',
  ONBOARDING_BIRTH_YEAR_DECLINED_ID: 'onboarding.birth-year-declined-button',
  ONBOARDING_CALCULATION_SEX_DECLINED_ID: 'onboarding.calculation-sex-declined-button',
  ONBOARDING_CONFIRM_PLAN_ID: 'onboarding.confirm-plan-button',
  ONBOARDING_CONFIRM_PROFILE_ID: 'onboarding.confirm-profile-button',
  ONBOARDING_CURRENT_PAIN_NO_ID: 'onboarding.current-pain-no-button',
  ONBOARDING_DOCTOR_RESTRICTION_NO_ID: 'onboarding.doctor-restriction-no-button',
  ONBOARDING_EQUIPMENT_INPUT_ID: 'onboarding.equipment-input',
  ONBOARDING_EXPERIENCE_INPUT_ID: 'onboarding.experience-input',
  ONBOARDING_HEIGHT_INPUT_ID: 'onboarding.height-input',
  ONBOARDING_HOME_ID: 'onboarding.home-button',
  ONBOARDING_MANUAL_START_ID: 'onboarding.manual-start-button',
  ONBOARDING_NUTRITION_HYBRID_ID: 'onboarding.nutrition-hybrid-button',
  ONBOARDING_ORDINARY_DAY_INPUT_ID: 'onboarding.ordinary-day-input',
  ONBOARDING_ORDINARY_FITNESS_NO_ID: 'onboarding.ordinary-fitness-doubt-no-button',
  ONBOARDING_PLAN_REVIEW_ID: 'onboarding.plan-review-screen',
  ONBOARDING_RECOMPOSITION_ID: 'onboarding.recomposition-button',
  ONBOARDING_REVIEW_ID: 'onboarding.review-screen',
  ONBOARDING_SAVE_DRAFT_ID: 'onboarding.save-draft-button',
  ONBOARDING_STRENGTH_ID: 'onboarding.strength-button',
  ONBOARDING_SUPERVISED_ONLY_NO_ID: 'onboarding.supervised-only-no-button',
  ONBOARDING_TRAINING_DAYS_INPUT_ID: 'onboarding.training-days-input',
  ONBOARDING_WEIGHT_INPUT_ID: 'onboarding.weight-input',
  ONBOARDING_WORKOUT_DURATION_INPUT_ID: 'onboarding.workout-duration-input',
  PASSWORD_INPUT_ID: 'auth.password-input',
  PASSWORD_VISIBILITY_BUTTON_ID: 'auth.password-visibility-button',
  PROFILE_BUTTON_ID: 'profile.open-button',
  PROFILE_SCREEN_ID: 'profile.screen',
  SUBMIT_BUTTON_ID: 'auth.submit-button',
  TODAY_SCREEN_ID: 'today.screen',
}
