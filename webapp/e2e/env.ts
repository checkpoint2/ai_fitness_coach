...
export const composeProjectName =
  process.env.COMPOSE_PROJECT_NAME ?? `ai-fitness-coach-${repositoryHash}`
...
export const defaultDatabaseUrl = `postgresql://superuser:superpassword@localhost:${defaultPostgresTestPort}/ai_fitness_coach_test?schema=public`
